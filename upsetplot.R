## Remember to set your working directory!! (it should contain the 'gene_presence_absence.csv' file generated by Roary)
## setwd("path_to_your_WD")


## To load or install&load all required libraries
packages = c('dplyr','ComplexHeatmap')
